...
export default function ParentDashboard() {
  ...
  return (
    <div className="pb-24 bg-gray-50 min-h-screen">
      ...
      {/* Bottom Nav */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-2 flex justify-around items-center z-20 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        ...
        <button
          onClick={() => navigate('/parent-app/rapor')}
          className="flex flex-col items-center text-gray-400 hover:text-indigo-600 p-2"
        >
        ...
        <button
          onClick={() => navigate('/parent-app/p5')}
          className="flex flex-col items-center text-gray-400 hover:text-emerald-600 p-2"
        >
          <BookOpen className="w-6 h-6 mb-1" />
          <span className="text-[10px] font-medium">P5</span>
        </button>

        <button
          onClick={() => navigate('/parent-app/chat')}
          className="flex flex-col items-center text-gray-400 hover:text-blue-600 p-2"
        >
