    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 relative before:absolute before:inset-0 before:left-6 before:w-0.5 before:bg-slate-200/80 before:hidden md:before:block">
        {filteredEntries.length === 0 ? (
          <div className="p-8 text-center bg-white border border-dashed border-slate-200 rounded-2xl md:ml-12">
            <div className="mb-2">
              {!isApiConnected ? (
            ...
            <p className="text-sm font-bold text-slate-800">Belum Ada Catatan Jurnal Wali Kelas</p>
