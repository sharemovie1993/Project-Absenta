    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-200/80 dark:border-slate-800 shadow-sm mb-5 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3.5">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-300">
          ...
          <span>
            Total <strong className="text-slate-900 dark:text-white font-extrabold">{studentCount.total} Siswa</strong>
            <span className="text-slate-400 ml-1 text-[11px]">({studentCount.male} L / {studentCount.female} P)</span>
          </span>
        </div>
      </div>

      {/* Right: Compact Search & Export Button */}
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs px-3.5 py-1.5 rounded-xl shadow-sm transition-all active:scale-95 cursor-pointer whitespace-nowrap"
        >
