    ...
    <div className="space-y-4">
      {activeOpnameSessionId ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex lg:hidden items-center gap-3 pb-2 border-b border-slate-100 dark:border-slate-800">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="p-1 -ml-1 text-slate-700 dark:text-slate-300"
            >
              <ArrowLeft size={20} />
            </button>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
              <h3 className="font-bold text-gray-800 dark:text-slate-100 text-base">Sesi Audit Stock Opname</h3>
              <p className="text-xs text-gray-500 dark:text-slate-400">Daftar sesi pemeriksaan berkala dan pencocokan fisik stok barang riil toko vs sistem.</p>
            </div>
