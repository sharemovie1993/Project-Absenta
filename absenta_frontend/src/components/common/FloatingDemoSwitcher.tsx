          ...
          {isOpen && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4 bg-slate-950/60 backdrop-blur-xs">
              ...
              >
                ...
                {/* Compact List Peran Clustered */}
                <div className="space-y-3.5 overflow-y-auto custom-scrollbar pr-1 -mr-1 flex-1 max-h-[380px]">
                  {clusteredProfiles.map((group) => (
                    <div key={group.id} className="space-y-1.5">
                      <div className="flex items-center justify-between px-1 py-0.5 border-b border-slate-100 dark:border-slate-800">
                        ...
                        {group.profiles.map((profile) => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                "w-full px-2.5 py-1.5 rounded-xl border text-left transition-all duration-150 flex items-center justify-between gap-2.5 cursor-pointer",
                            ...
                            >
                              <div className="flex items-center gap-2 min-w-0 flex-1">
                                <div className={cn(
                                  "w-7 h-7 rounded-lg flex items-center justify-center shadow-2xs bg-gradient-to-br transition-transform group-hover:scale-105 shrink-0",
                                  profile.gradient
                                )}>
                                  {isThisLoading ? (
                              ...
                              <div className="w-5 h-5 rounded-md bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 shrink-0">
