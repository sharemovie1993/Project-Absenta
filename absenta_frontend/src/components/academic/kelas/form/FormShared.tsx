...
export const DetailRow = ({ icon, label, value, className = "" }: { icon: React.ReactNode, label: string, value: React.ReactNode, className?: string }) => (
...
export const SectionCard = ({ children, title, icon: Icon, fullWidth = false }: { children: React.ReactNode, title?: string, icon?: any, fullWidth?: boolean }) => (
  <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:shadow-md group">
    {title && (
