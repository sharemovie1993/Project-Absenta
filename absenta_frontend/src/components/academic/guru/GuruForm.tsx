    ...
    try {
      ...
      if (isEditMode && guruId) {
        const updatePayload: UpdateGuruPayload = {
          ...
          nama_ibu_kandung: data.nama_ibu_kandung || undefined,
          nama_guru: data.nama,
          email: data.email || undefined,
          no_hp: data.no_hp?.trim() ? data.no_hp : undefined,
          alamat: data.alamat,
          dusun: data.dusun || undefined,
          ...
          kode_pos: data.kode_pos || undefined,
          tanggal_lahir: data.tanggal_lahir?.trim() ? data.tanggal_lahir : undefined,
          jenis_kelamin: data.jenis_kelamin,
          agama: data.agama,
          status_kepegawaian: data.status_kepegawaian,
          pendidikan_terakhir: data.pendidikan_terakhir,
          pangkat_golongan: data.pangkat_golongan || undefined,
          tmt_guru: data.tmt_guru || undefined,
