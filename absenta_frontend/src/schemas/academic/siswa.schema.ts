...
export const siswaSchema = z.object({
  ...
  hobi: z.string().optional().or(z.literal('')),
  cita_cita: z.string().optional().or(z.literal('')),
  is_osis: z.boolean().optional().default(false),
  is_mpk: z.boolean().optional().default(false),
  ekskul_1: z.string().optional().or(z.literal('')),
  ekskul_2: z.string().optional().or(z.literal('')),
