    ...
    return [
      {
        ...
        description: 'Siswa terdaftar di kelas ini',
        icon: Users,
        badgeText: 'Aktif',
      ...
      },
      {
        ...
        value: avgScore,
        description: 'Rata-rata akumulasi nilai kelas',
        icon: Calculator,
      ...
      },
      {
        ...
        description: `Nilai: ${filteredStudents[0]?.rata_rata || 0}`,
        icon: Award,
        badgeText: '#1 Class Leader',
        badgeVariant: 'warning' as const,
      },
      {
        title: 'Kelengkapan Catatan',
        value: `${filledCatatan}/${total}`,
        description: 'Catatan wali kelas terisi',
        icon: CheckCircle,
        badgeText: filledCatatan === total && total > 0 ? '100% Complete' : 'In Progress',
        badgeVariant: filledCatatan === total && total > 0 ? ('success' as const) : ('info' as const),
      },
    ];
  }, [filteredStudents]);
