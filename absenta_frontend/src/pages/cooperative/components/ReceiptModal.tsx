      ...
      >
        {selectedSale && (
          <div className="space-y-6">
            ...
            <div 
              style={receiptStyles}
              className="dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-lg max-w-sm mx-auto font-mono text-sm text-slate-800 dark:text-slate-200"
            >
              ...
              <div className="space-y-1 text-xs font-semibold">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-900 dark:text-slate-100">
                    {memberInfo?.User?.full_name || (user?.full_name as string) || 'Tamu'}{' '}
