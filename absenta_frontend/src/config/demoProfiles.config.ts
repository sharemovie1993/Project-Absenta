...
export const DEMO_ROLE_PROFILES: DemoRoleProfile[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    badgeColor: 'bg-teal-500/15 text-teal-700 dark:text-teal-300 border-teal-200 dark:border-teal-800',
    description: 'Wali Kelas X TJKT 1 & Guru Bahasa Indonesia, monitoring presensi bulanan, leger nilai & rapor',
    iconName: 'UserCheck',
  ...
  },
  {
    ...
    simulatedName: 'Siti Patimah Demo',
    email: 'guru.matematika@absenta.id',
    password: 'password123',
    badge: 'Pengajar Matematika',
    badgeColor: 'bg-sky-500/15 text-sky-700 dark:text-sky-300 border-sky-200 dark:border-sky-800',
    description: 'Guru Matematika XII TP 1, kelola jadwal KBM aktif, rekap per mapel & jurnal pertemuan',
    iconName: 'GraduationCap',
    gradient: 'from-sky-500 to-blue-700 text-white',
    border: 'border-sky-300 dark:border-sky-700'
  },
  {
    id: 'demo-guru-produktif',
    category: 'TEACHING',
    roleCode: 'GURU',
    title: 'Guru Produktif TKJ',
    simulatedName: 'Asep Demo',
    email: 'guru.produktif@absenta.id',
    password: 'password123',
    badge: 'Wali Kelas X TJKT 2',
    badgeColor: 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-800',
    description: 'Guru Produktif Informatika & Wali Kelas X TJKT 2, rekap presensi kelas & rekap per mapel',
    iconName: 'Laptop',
    gradient: 'from-indigo-500 to-violet-700 text-white',
    border: 'border-indigo-300 dark:border-indigo-700'
  },
  {
    ...
    title: 'Pembina Eskul',
    simulatedName: 'Yayan Demo',
    email: 'pembina.pramuka@absenta.id',
    password: 'password123',
