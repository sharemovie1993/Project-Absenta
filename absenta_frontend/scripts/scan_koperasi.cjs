/**
 * scan_koperasi.cjs — Scan semua file modul Koperasi/Cooperative untuk auth patterns
 */
const fs = require('fs');
...
console.log('\n=== SCAN MODUL KOPERASI (COOPERATIVE) ===\n');
...
console.log('\nTotal file Koperasi (Cooperative):', results.length);
