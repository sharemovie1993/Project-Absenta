...
const RAPOR_DIRS = [
  path.join(SRC_DIR, 'pages/rapor'),
  path.join(SRC_DIR, 'components/rapor')
];
...
RAPOR_DIRS.forEach(d => scanDir(d));

console.log('\n=== SCAN MODUL RAPOR / RAPORT ===\n');
...
console.log(`\nTotal file Rapor / Raport: ${totalFiles}\n`);
