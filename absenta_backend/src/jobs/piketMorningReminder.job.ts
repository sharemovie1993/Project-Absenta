...
export default defineCronJob({
  ...
  async run() {
    ...
    appLogger.info({ job: PIKET_MORNING_REMINDER_JOB_NAME, processedCount }, `Selesai mengirim pengingat pagi piket guru ke WA Group. Terkirim: ${processedCount}`);
  }
});
