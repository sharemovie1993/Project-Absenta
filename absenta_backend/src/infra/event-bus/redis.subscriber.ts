import { handleSesiSummaryUpdate, handleSessionAttendanceUpdate, handleSesiStatusUpdate, handleAbsenGuruUpdate, handleGerbangTapUpdate, handleSesiReminderUpdate, handleGateTapDomainEvent } from './attendance.events';
...
export async function subscribeRedisEvents(opts: { redis: any; io: any; ioApi: any }) {
  ...
  const handlers: Record<string, (payload: any) => Promise<void>> = {
    ...
    'events:sesi_reminder_updated': async (payload) => handleSesiReminderUpdate(io, ioApi, payload),
