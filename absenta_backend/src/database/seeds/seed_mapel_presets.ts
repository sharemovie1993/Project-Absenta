...
export async function seedMapelPresets(prisma: PrismaClient) {
  ...
  const mppPresets: PresetItem[] = [
    ...
    { category: 'PILIHAN_SMK', nama_mapel: 'Mata Pelajaran Pilihan - TBSM / TSM', kode_mapel: 'MPP TSM' },
  ...
  const kkPresets: PresetItem[] = [
    ...
    { category: 'KEJURUAN', nama_mapel: 'Konsentrasi Keahlian - TBSM / TSM', kode_mapel: 'KK TSM' },
