...
export function isMasterInstance(): boolean {
...
export const waGatewayServiceLocal = {
  /**
...
export function initClusterRpc() {
...
async export function callMasterViaRpc(method: string, tenantId: string, args: any[] = []): Promise<any> {
  if (isMasterInstance()) {
