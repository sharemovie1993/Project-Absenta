  ...
  for (const [index, row] of rows.entries()) {
    ...
    try {
      ...
      const createInput: any = {
        ...
        alamat: getRowValue(row, 'alamat', 'Alamat', 'Alamat Lengkap'),
        provinsi: getRowValue(row, 'provinsi', 'Provinsi'),
        kabupaten: getRowValue(row, 'kabupaten', 'Kabupaten', 'Kab/Kota', 'Kota', 'Kabupaten/Kota'),
        kecamatan: getRowValue(row, 'kecamatan', 'Kecamatan'),
        kelurahan: getRowValue(row, 'kelurahan', 'Kelurahan', 'Desa', 'Kelurahan/Desa'),
        rt: getRowValue(row, 'rt', 'RT'),
        rw: getRowValue(row, 'rw', 'RW'),
        kode_pos: getRowValue(row, 'kode_pos', 'Kode Pos', 'Kode_Pos'),
        lintang: getRowValue(row, 'lintang', 'Lintang', 'Latitude', 'lat', 'Lat'),
        bujur: getRowValue(row, 'bujur', 'Bujur', 'Longitude', 'lng', 'Long', 'Lng'),
        koordinat: getRowValue(row, 'koordinat', 'Koordinat', 'Geo Location', 'Coordinates'),
        dusun: getRowValue(row, 'dusun', 'Dusun', 'Kampung'),
        transportasi: getRowValue(row, 'transportasi', 'Transportasi', 'Moda Transportasi'),
        ...
        nik_ayah: getRowValue(row, 'nik_ayah', 'NIK Ayah', 'NIK_Ayah'),
        no_hp_ayah: normalizePhone(getRowValue(row, 'no_hp_ayah', 'No. HP Ayah', 'No HP Ayah', 'HP Ayah', 'Telepon Ayah', 'WA Ayah')),
        nama_ibu: getRowValue(row, 'nama_ibu', 'Ibu', 'Nama Ibu'),
        nik_ibu: getRowValue(row, 'nik_ibu', 'NIK Ibu', 'NIK_Ibu'),
        no_hp_ibu: normalizePhone(getRowValue(row, 'no_hp_ibu', 'No. HP Ibu', 'No HP Ibu', 'HP Ibu', 'Telepon Ibu', 'WA Ibu')),
        nama_wali: getRowValue(row, 'nama_wali', 'Wali', 'Nama Wali'),
        nik_wali: getRowValue(row, 'nik_wali', 'NIK Wali', 'NIK_Wali'),
        no_hp_wali: normalizePhone(getRowValue(row, 'no_hp_wali', 'No. HP Wali', 'No HP Wali', 'HP Wali', 'Telepon Wali', 'WA Wali')),
        no_hp_ortu: normalizePhone(getRowValue(row, 'no_hp_ortu', 'No. HP Orang Tua', 'No HP Ortu', 'HP Ortu', 'Telepon Ortu', 'WA Ortu')),
