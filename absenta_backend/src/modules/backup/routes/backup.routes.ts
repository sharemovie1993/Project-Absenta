...
export async function backupRoutes(fastify: any) {
    fastify.get('/admin/backups', { preHandler: [requireCapability("cadangan.view.cadangan")] }, BackupController.list);
    fastify.get('/admin/backups/:id/download', { preHandler: [requireCapability("cadangan.view.cadangan")] }, BackupController.download);
    fastify.post('/admin/backups/:id/restore', { preHandler: [requireCapability("cadangan.manage.cadangan")] }, BackupController.restore);
