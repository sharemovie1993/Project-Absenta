...
export default async function ukkSklRoutes(fastify: any) {
  ...
  fastify.get('/ukk', { preHandler: requireCapability('academic.view.mapel') }, UkkSklController.getUkk);
  ...
  fastify.get('/skl', { preHandler: requireCapability('academic.view.siswa') }, UkkSklController.getSkl);
