...
export default async function p5Routes(fastify: any) {
  ...
  fastify.get('/projek', { preHandler: requireCapability('academic.view.mapel') }, P5Controller.getProjek);
  ...
  fastify.post('/nilai', { preHandler: requireCapability('academic.manage.kbm') }, P5Controller.upsertNilai);
  fastify.post('/nilai/bulk', { preHandler: requireCapability('academic.manage.kbm') }, P5Controller.upsertBulkNilai);
